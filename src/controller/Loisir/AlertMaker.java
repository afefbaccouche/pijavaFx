...
public static final String ICON_IMAGE_LOC = "/resources/icon.png";
    ...
    public static int showMultipleChoiceAlert(String title,String content)
{
    ButtonType Assureur = new ButtonType("Assureur", ButtonBar.ButtonData.OK_DONE);
    ButtonType Client = new ButtonType("Client", ButtonBar.ButtonData.OK_DONE);
       ButtonType Expert = new ButtonType("Expert", ButtonBar.ButtonData.OK_DONE);
...
public static boolean showChoiceAlert(String title,String content)
{
Alert alert = 
...
return false;
 ...
 public static void showMaterialDialogClose(StackPane root, Node nodeToBeBlurred, List<JFXButton> controls, String header, String body, Node N) {
        BoxBlur blur = new BoxBlur(3, 3, 3);
        if (controls.isEmpty()) {
            controls.add(new JFXButton("OK"));
        }
