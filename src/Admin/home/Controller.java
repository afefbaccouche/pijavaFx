...
import controller.Services.AjoutServiceController;
    ...
    public void handleClicks(ActionEvent actionEvent) {
        ...
        if (actionEvent.getSource() == btnSante) {
            ...
            try {
                ...
                //  final int j = i;
                nodes = FXMLLoader.load(getClass().getResource("/view/superAdmin/FXMLSuperAdmin.fxml"));
        ...
        if (actionEvent.getSource() == btnConsoma) {
            ...
            try {
                ...
                //  final int j = i;
                nodes = FXMLLoader.load(getClass().getResource("/Consomation/Presentation/Admin/AjoutRestaurant.fxml"));
